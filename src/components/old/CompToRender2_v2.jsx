  ...
  return (
    <section className="h-screen">
      <div id="CompToRender2" className="max-w-sm lg:max-w-4xl lg:flex m-auto text-cyan-100">
        <div className="glow h-48 lg:h-auto lg:w-5/12 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden flex items-center justify-center" title="photo">
