    ...
    <nav className="flex items-center justify-between flex-wrap p-6 bg-teal-500">
      ...
      >
        <div className="text-sm lg:flex-grow">
          <NavLink to="/topten" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            Ten Most Wanted
          </NavLink>
          <NavLink to="/index/cei" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            CEI
          </NavLink>
          <NavLink to="/index/counterintelligence" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            Counterintelligence
          </NavLink>
          <NavLink to="/index/cyber" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            Cyber
          </NavLink>
          <NavLink to="/index/kidnapmissing" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            Kidnappings & Missing Persons
          </NavLink>
          <NavLink to="/index/seekinginfo" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            Seeking Information
          </NavLink>
          <NavLink to="/index/vicap" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
            ViCAP
          </NavLink>
          <NavLink to="/index/additional" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 mr-4">
